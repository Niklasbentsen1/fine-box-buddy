import { t as createCsrfMiddleware } from "./assets/createCsrfMiddleware-B2To0gPJ.js";
import "react";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-BnFB0Mlt.js");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./assets/router-cxIfq0D6.js").then((n) => n.t),
		import("./assets/start-B5G_9-Bx.js"),
